...
public class InfuseCommand {
    ...
    public int help(CommandSourceStack ctx) {
        ...
        ctx.getSender().sendMessage(Component.text(" |- setscore ", NamedTextColor.AQUA).append(Component.text("<targets> <score>", NamedTextColor.GOLD)).append(Component.text(": Sets a player's score.  Also rerolls their effects.", NamedTextColor.WHITE)));
        ctx.getSender().sendMessage(Component.text(" |- getscore ", NamedTextColor.AQUA).append(Component.text("[targets]", NamedTextColor.GOLD)).append(Component.text(": Gets a player's score", NamedTextColor.WHITE)));
        ctx.getSender().sendMessage(Component.text(" \\- give ", NamedTextColor.AQUA).append(Component.text("<targets> <item> [count]", NamedTextColor.GOLD)).append(Component.text(": Gives a player an infuse item.", NamedTextColor.WHITE)));
        return 1;
    }
